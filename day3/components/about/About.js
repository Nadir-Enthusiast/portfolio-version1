            ...
            <div className="container mainPage about">
                <div className="text-info">
                  ...
                  <div className="about-text">
                    ...
                    <p>I've been working with such JS frameworks as React, </p>
                    <p>Express, Node, Anime etc. I also know basics of python.</p>

                    <h2>What sites do I make?</h2>
                    <p>I used to make E-Commerce, Social Media, Messengers.</p>
